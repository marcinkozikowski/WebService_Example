 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://rsi.jg.org/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://rsi.jg.org/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://rsi.jg.org/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://rsi.jg.org/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
